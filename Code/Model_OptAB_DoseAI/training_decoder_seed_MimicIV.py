...
save = str('Trained_Encoder_seed_'+str(num_seed_i)+'.pth')
save2 = str('Trained_Decoder_seed_'+str(num_seed_i)+'.pth')

folder_data = 'server/data_mimic/data_pred_three/' 
...
with open(folder_data+'sepsis_all_1_indices_train.pkl', 'rb') as handle:
...
model.load_state_dict(torch.load('/home/jaschob/'+save))
