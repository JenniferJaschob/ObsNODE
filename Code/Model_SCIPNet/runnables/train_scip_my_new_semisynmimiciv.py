...
def main(args: DictConfig):
    ...
    for seed in [106,107]:#[101,102,103,104,105]:
        ...
        checkpoint_path = save_dir / f"propensity_treatment_{seed}_{args.dataset.name}.ckpt"
        ...
        checkpoint_path = save_dir / f"propensity_history_{seed}_semisynmimiciv.ckpt"
        ...
        checkpoint_path = save_dir / f"encoder_{seed}_semisynmimiciv.ckpt"
        ...
        if args.model.train_decoder:
            checkpoint_path = save_dir / f"decoder_{seed}_semisynmimiciv.ckpt"
...
# ============================== Custom Evaluation ==============================
    ...
    for seed in seeds:
        ...
        enc_ckpt = save_dir / f"encoder_{seed}_semisynmimiciv.ckpt"
        dec_ckpt = save_dir / f"decoder_{seed}_semisynmimiciv.ckpt"
    ...
    eval_script.heatmap_pred(
        ...
        loss='rmse',
        save_link=Path(get_original_cwd()) / 'results' / 'rmse_heatmap_syn_value1.png',
        save_map=Path(get_original_cwd()) / 'results' / 'rmse_heatmap_syn_value1.pkl',
        index=0,
        vmin=0,
        vmax=1.0 
    )
