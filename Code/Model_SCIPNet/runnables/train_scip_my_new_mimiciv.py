...
def main(args: DictConfig):
    ...
    for seed in [100]:#[100,101,102,103,104]:
        ...
        checkpoint_path = save_dir / f"propensity_treatment_{seed}.ckpt"
        ...
        checkpoint_path = save_dir / f"propensity_history_{seed}.ckpt"
        ...
        checkpoint_path = save_dir / f"encoder_{seed}.ckpt"
        ...
        if args.model.train_decoder:
            checkpoint_path = save_dir / f"decoder_{seed}.ckpt"
...
# ============================== Custom Evaluation ==============================
    ...
    for seed in seeds:
        ...
        enc_ckpt = save_dir / f"encoder_{seed}.ckpt"
        dec_ckpt = save_dir / f"decoder_{seed}.ckpt"
    ...
    eval_script.heatmap_pred(
        ...
        loss='rmse',
        save_link=Path(get_original_cwd()) / 'results' / 'rmse_heatmap_SOFA.png',
        save_map=Path(get_original_cwd()) / 'results' / 'rmse_heatmap_SOFA.pkl',
        index=0,
        vmin=0,
        vmax=1.0 
    )
    eval_script.heatmap_pred(
        ...
        max_horizon=max_seq_len - 1,
        loss='rmse',
        save_link=Path(get_original_cwd()) / 'results' / 'rmse_heatmap_creatinine.png',
        save_map=Path(get_original_cwd()) / 'results' / 'rmse_heatmap_creatinine.pkl',
        index=1,
        vmin=0,
        vmax=1.0
    )
    ...
    eval_script.heatmap_pred(
        ...
        max_horizon=max_seq_len - 1,
        loss='rmse',
        save_link=Path(get_original_cwd()) / 'results' / 'rmse_heatmap_bilirubin_total.png',
        save_map=Path(get_original_cwd()) / 'results' / 'rmse_heatmap_bilirubin_total.pkl',
        index=1,
        vmin=0,
        vmax=1.0
    )
    eval_script.heatmap_pred(
        ...
        max_horizon=max_seq_len - 1,
        loss='rmse',
        save_link=Path(get_original_cwd()) / 'results' / 'rmse_heatmap_alt.png',
        save_map=Path(get_original_cwd()) / 'results' / 'rmse_heatmap_alt.pkl',
        index=1,
        vmin=0,
        vmax=1.0
    )
