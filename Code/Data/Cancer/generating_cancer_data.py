...
# and Adaptation from https://github.com/philippwendland/DoseAI/
...
if __name__ == "__main__":
    ...
    args.max_horizon=5
    args.multistep=True
    args.save_raw_datapath='/Users/jaschob/Desktop/DoseAI/data/'
    args.save_transformed_datapath='/Users/jaschob/Desktop/DoseAI/data/'
    ...
    if args.save_transformed_datapath != None:
        ...
        write_to_file(
            pickle_map,
            f"{args.save_transformed_datapath}/data_dict_{coeff}_{coeff}.p",
        )
