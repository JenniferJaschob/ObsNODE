...
class SyntheticDatasetCollection:
    ...
    def __repr__(self):
        return f"SyntheticDatasetCollection(train_f={self.train_f}, val_f={self.val_f}, test_cf_one_step={self.test_cf_one_step}, test_cf_treatment_seq={self.test_cf_treatment_seq})"
