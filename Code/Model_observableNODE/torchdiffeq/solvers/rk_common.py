# file by Anna Steffens, maybe an older version? Current version on 
# https://github.com/rtqichen/torchdiffeq has a method valid_callbacks, which produces
# an error while using AdeptiveStepSizeSolver like dopri5
import bisect
import collections
import torch
from event_handling.event_handling import find_event
from solvers.interp import _interp_evaluate, _interp_fit
from misc.miscellaneous import (_compute_error_ratio, _select_initial_step, _optimal_step_size)
from misc.miscellaneous import Perturb
from solvers.solvers import AdaptiveStepsizeEventODESolver
