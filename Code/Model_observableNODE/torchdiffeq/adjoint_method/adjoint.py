...
from misc.miscellaneous import check_inputs_adjoint, _flat_to_shape, _mixed_norm,_check_inputs, _all_callback_names,_all_adjoint_callback_names
...
def odeint_adjoint(func, y0, t, *, rtol=1e-7, atol=1e-9, method=None, options=None, event_fn=None,
    ...
    #shapes, func, y0, t, rtol, atol, method, options, event_fn, decreasing_time = check_inputs_adjoint(func, y0, t, rtol, atol, method, options, event_fn, SOLVERS)
